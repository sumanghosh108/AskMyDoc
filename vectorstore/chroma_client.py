...
class ChromaClient:
    ...
    - Document embedding and storage (via ChromaDB's built-in default)
    ...
    def _initialize_embedding_function(self):
        """Initialize ChromaDB's default embedding function (onnxruntime-based)."""
        try:
            self._embedding_fn = embedding_functions.DefaultEmbeddingFunction()
            log.info("Embedding function loaded (ChromaDB default)")
        except Exception as e:
            log.error("Failed to load embedding function", error=str(e))
            raise
    ...
    def add_documents(
        ...
        try:
            ...
            log.info("Adding documents to collection", document_count=len(documents))
    ...
    def query(
        ...
        """
        try:
            # Query collection (ChromaDB handles embedding automatically)
